    ...
    <el-dialog :title="'新增专家'"
      ...
      <el-form :model="userForm"
        ...
        <el-form-item label="身份证号："
          ...
          <template slot-scope="scope">
            ...
            <div class="verify fs-14 c-white zx-flex align justify cursor"
                 @click.stop.prevent="idcardVerify(userForm.idcard)">验证</div>
          </template>
        </el-form-item>
        ...
        <el-form-item label="出生日期："
                      prop="birthday">
          <el-input v-model="userForm.birthday"
                    readonly
                    placeholder="根据身份证验证"></el-input>
        </el-form-item>
        ...
        <el-form-item label="个人邮箱：">
          <el-input v-model="userForm.personalmailbox"
        ...
        <el-form-item label="微信号：">
          <el-input v-model="userForm.wechatnumber"
                    placeholder="请输入用户微信号"></el-input>
        </el-form-item>
        <el-form-item label="银行账号：">
          <el-input v-model="userForm.bankaccount"
                    placeholder="请输入用户银行账号"></el-input>
        </el-form-item>
        <el-form-item label="开户行：">
          <template slot-scope="scope">
            <el-select v-model="userForm.openingbank"
                       placeholder="请选择开户行">
        ...
        <el-form-item label="紧急联系人电话：">
          <el-input v-model="userForm.emergencycontactnumber"
                    placeholder="请输入紧急联系人电话"></el-input>
        </el-form-item>
        <el-form-item label="公司名称：">
          <el-input v-model="userForm.corporatename"
        ...
        <el-form-item label="专家职称："
          ...
          <template slot-scope="scope">
            <div class="unitAddress zx-flex align between">
              <el-select v-model="userForm.experttitle"
                         class="zhuanjia"
                         placeholder="请选择">
        ...
        <el-form-item label="技术领域：">
          <el-input v-model="userForm.technicalfield"
                    :readonly="true"
                    type="textarea"
                    :autosize="{ minRows: 1, maxRows: 3}"
                    placeholder="请选择技术领域"
...
export default {
  ...
  methods: {
    ...
    subjectFooter (index) {
      switch (index) {
        case 1:
          ...
          //   break
          // }
          this.userForm.subject = this.subjectValList.join(',')
    ...
    technicalfieldFooter (index) {
      switch (index) {
        case 1:
          this.userForm.technicalfield = this.technicalfieldValList.join(',')
    ...
    // 验证
    idcardVerify (idCard) {
      this.userForm.birthday = this.getBirthdayFromIdCard(idCard)
      this.userForm.sex = this.getGenderFromIdCard(idCard)
    },
    // 获取出生日期
    ...
    onDialogFooter (index) {
      switch (index) {
        case 1:
          this.submitForm('userForm').then(bool => {
            if (!bool) return false
            let loading = this.$loading()
            // let query = Object.assign({}, this.userForm, this.)
            let query = this.userForm
            console.log(query)

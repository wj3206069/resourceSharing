...
<script>
import EquAudit from '@/components/dialog/audit/EquAuditPlat'
import AuditMany from '@/components/dialog/AuditManyDialog'
import { tablelistPlat } from '@/api/waitDeal/EquExaAPI.js'
